...
export default function Home () {
    return (
        <main className="relative w-dvw h-dvh overflow-hidden bg-bg-base text-text-primary">

            <video className="absolute top-0 left-0 w-full h-full object-cover z-0 opacity-70" autoPlay loop muted playsInline preload="auto">
                <source src={hkVideo} type="video/mp4" />
            </video>

            <div className="absolute inset-0 bg-linear-to-r from-bg-base via-bg-base/40 to-transparent z-10 pointer-events-none"/>
