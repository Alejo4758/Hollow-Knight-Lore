...
export default function Explore () {
    return (
        <main className="relative w-full min-h-screen overflow-x-hidden bg-bg-base text-text-primary">
            ...
            <video className="fixed top-0 left-0 object-cover w-full h-full z-0 opacity-70" autoPlay loop muted playsInline preload="auto">
                <source src={hkVideo} type="video/mp4"/>
            </video>
        
            <div className="absolute inset-0 pointer-events-none z-10 bg-bg-base/60"/>
